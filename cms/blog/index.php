          ...
          <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
              <?php
               ...
               ?>
                <a href="post.php?post_id=<?php echo $slider_id;  ?>"><img src="images/<?php echo $slider_image;  ?>" alt="Slider1"></a>
          ...
          <div class="post">
            <div class="row">
              ...
              <div class="col-md-8 post-title">
                <a href="post.php?post_id=<?php echo $id;  ?>"><h2 style="text-decoration: none;"><?php echo "$title";  ?></h2></a>
            ...
            <div class="bottom">
              <span class="first"><i class="fa fa-folder"></i> <a href="index.php?cat= <?php echo $id;  ?>"><?php echo ucfirst($categories);  ?></a></span>
